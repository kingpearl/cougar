...
# ENV PKG=mongodb-linux-x86_64-ubuntu2004-4.4.8
...
# RUN curl -sL https://releases.hashicorp.com/consul/1.10.1/consul_1.10.1_linux_amd64.zip > $PKG.zip && unzip $PKG.zip && rm $PKG.zip && cp -R $PKG /usr/local/bin/
